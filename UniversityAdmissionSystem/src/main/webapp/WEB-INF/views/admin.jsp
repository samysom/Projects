...
<a href="./programoffermainmvc"><div class="poffer"><input type="button" value="Program Offered" name="poffer" style="height:150px; width:225px; background-color:#0C3; border-radius:50px; font-size:24px" /></div></a>
<a href="./programschemainmvc"><div class="psch"><input type="button" value="Program Scheduled" name="poffer" style="height:150px; width:225px; background-color:#0C3; border-radius:50px; font-size:24px" /></div></a>
<a href="./logoutmvc"><div class="b"><input type="button" value="Log Out" name="accept" style="height:60px; width:150px; background-color:#6C9; border-radius:25px; font-size:24px"/></div></a>
</body>
</html>