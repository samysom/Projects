...
<title>Update University Program</title>
<style>
.offer
{
	position:absolute;
...
%>
<form action="./programofferedupdatemvclog" method="post">
<div class="body"></div>
<div class="offer">
<fieldset style="width:10%">
<legend align="center"><b><i>Update Programs</i></b></legend>
<table border="2" bgcolor="#3FC">
...
<tr><td><input type="submit" value="Update Program" name="add" /></td></tr>
</table>
</fieldset>
</div>
</form>
